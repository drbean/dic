...
[ "access", "dubai", 1, "all", "In the story, Sally came from somewhere like Iran or Iraq.", "True" ],
[ "access", "dubai", 2, "all", "In one scenario, the two friends are on a vacation in the desert.", "True" ],
[ "access", "dubai", 3, "all", "In one scenario, Sally speaks Arabic, but Sally's friend doesn't.", "True" ],
[ "access", "dubai", 4, "all", "In one scenario, Sally's friend is a doctor who is on vacation.", "False" ],
[ "access", "dubai", 5, "all", "In one scenario, Sally is a friend of bin Laden, and bin Laden is waiting for them.", "False" ],
[ "access", "dubai", 6, "all", "In one scenario, Sally has information for the men about bin Laden's camels.", "False" ],

[ "access", "bridewriter", 1, "all", "Sally will help her friend escape when the terrorist try to kill her.", "True" ],
[ "access", "bridewriter", 2, "all", "Riding camels will be more exhausting for Sally than Sally's friend.", "True" ],
[ "access", "bridewriter", 3, "all", "The prince does not know that his servants want to kill his bride.", "True" ],
[ "access", "bridewriter", 4, "all", "Sally and her friend will find it uncomfortable speaking to the tour guides.", "False" ],
[ "access", "bridewriter", 5, "all", "The prince told his servants to kill his bride.", "False" ],
[ "access", "bridewriter", 6, "all", "Sally intends to kill the camels so she can fit them in her car.", "False" ],
