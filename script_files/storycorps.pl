...
push @$questions,
[ "intermediate", "viviano", 1, "all", "Dana wanted to become a nurse because her mom had cancer.", "True" ],
[ "intermediate", "viviano", 2, "all", "Sarafino thinks her mom is a hero.", "True" ],
[ "intermediate", "viviano", 3, "all", "Dana learns about love, hope and fear from her patients.", "True" ],
[ "intermediate", "viviano", 4, "all", "Dana learned her mom was going to die from a nurse.", "False" ],
[ "intermediate", "viviano", 5, "all", "Dana didn't want to become a nurse.", "False" ],
[ "intermediate", "viviano", 6, "all", "Patients are not prepared when they are told they are going to die.", "False" ];
